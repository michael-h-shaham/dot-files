...
if [ "$color_prompt" = yes ]; then
    PS1='${debian_chroot:+($debian_chroot)}\[\033[01;32m\]\u@\h\[\033[00m\]:\[\033[01;34m\]\w\[\033[00m\]  \[\e[1;33m\]$(parse_git_branch)\[\e[00m\] \n $ '
else
...
git-pull-vehicle() {
    start_dir=$(pwd)
    echo "pozyx_ros:" && cd ~/cvy_ws/src/pozyx_ros && git pull
    echo "f1tenth_system:" && cd ~/cvy_ws/src/f1tenth_system && git pull
