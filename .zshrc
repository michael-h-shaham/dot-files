...
git-pull-convoy() {
  ...
  echo "convoy_ros:" && cd ~/phd/convoy_ros && git pull
  git submodule update --remote
  echo "river-f1tenth:" && cd ~/phd/river-f1tenth && git pull
  cd $start_dir
}
...
__conda_setup="$('/Users/mshaham/opt/anaconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/Users/mshaham/opt/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/Users/mshaham/opt/anaconda3/etc/profile.d/conda.sh"
    else
        export PATH="/Users/mshaham/opt/anaconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
